...
describe('PokemonService', () => {
    ...
    describe('execute', () => {
        it('should process rules and execute successfully', async () => {
            ...
            const createData = { name: 'Pikachu', type: 'Electric', ability: 'Static', image: 'http://example.com/pikachu.png' }
    ...
    describe('create', () => {
        describe('rules', () => {
            ...
            it('should pass if pokemon name is unique', async () => {
                const createData = { name: 'Charizard', type: 'Fire/Flying', ability: 'Blaze', image: 'http://example.com/charizard.png' }
                const executionDTO = AuthDataFactory.createExecutionDTO('create', createData)
        ...
        describe('execution', () => {
            it('should create pokemon successfully', async () => {
                const createData = { name: 'Bulbasaur', type: 'Grass/Poison', ability: 'Overgrow', image: 'http://example.com/bulbasaur.png' }
                const executionDTO = AuthDataFactory.createExecutionDTO('create', createData)
                const mockPokemon = TestDataFactory.createPokemon({
                    name: 'Bulbasaur',
                    type: 'Grass/Poison',
