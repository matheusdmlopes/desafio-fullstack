...
export class MainEntity {
  ...
  @Field(() => String)
  type: string
  static typeZod = z.string().min(1)

  @Field(() => String)
  ability: string
  static abilityZod = z.string().min(1)

  @Field(() => String)
  image: string
  static imageZod = z.string().url()
...
export class CreateDTO implements createDTODBType {
  ...
  @Field(() => String)
  type: string
  static typeZod = MainEntity.typeZod

  @Field(() => String)
  ability: string
  static abilityZod = MainEntity.abilityZod

  @Field(() => String)
  image: string
  static imageZod = MainEntity.imageZod
...
export class UpdateDTO implements updateDTODBType {
  ...
  static typeZod = MainEntity.typeZod.optional()

  @Field(() => String, { nullable: true })
  ability?: string | Prisma.StringFieldUpdateOperationsInput
  static abilityZod = MainEntity.abilityZod.optional()

  @Field(() => String, { nullable: true })
  image?: string | Prisma.StringFieldUpdateOperationsInput
  static imageZod = MainEntity.imageZod.optional()
